...
class Page {
  ...
  /**
    ...
    * @param {number} index The index of this page in the Menu
     */
  constructor (name : string, content : MessageEmbed, reactions , index? : number | null) {
    this.name = name
...
export class Menu extends EventEmitter {
  ...
  /**
    ...
    * These names perform special functions and should only be used as reaction destinations.
    */
  constructor (channel : TextChannel, userID : string, pages : Page[], ms : number = 180000) {
    super()
